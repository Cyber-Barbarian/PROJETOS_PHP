...
<body>
    ...
    <form action="_inserir_fornecedor.php" method="post"">
        <div class="form-group">
            <label><h4>Cadastro de Fornecedores</h4></label>
            <input type="text" class="form-control" name="novo_fornecedor" placeholder="Digite o fornecedor que deseja adicionar">
